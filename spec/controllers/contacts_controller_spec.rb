  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contact as @contact" do
        ...
        post :create, {:contact => { "email" => "invalid value" }}, valid_session
        assigns(:contact).should be_a_new(Contact)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contact" do
        ...
        Contact.any_instance.should_receive(:update).with({ "email" => "MyString" })
        put :update, {:id => contact.to_param, :contact => { "email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contact as @contact" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contact.any_instance.stub(:save).and_return(false)
        put :update, {:id => contact.to_param, :contact => { "email" => "invalid value" }}, valid_session
        assigns(:contact).should eq(contact)
      end
